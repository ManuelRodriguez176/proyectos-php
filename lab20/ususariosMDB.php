...
class UsuariosMDB {
    ...
    public function conectarMongodb() {
        try {
            ...
            die("Ocurrió la siguiente excepción al tratar de conectarse a la base de datos: " . $e->getMessage());
        }
    }
    ...
    public function insertarRegistro($nombre, $apellido, $email, $edad) {
        try {
            ...
            echo "Ocurrió la siguiente excepción al tratar de guardar el registro: " . $e->getMessage() . "\n";
        }
    }
    ...
    public function obtenerRegistros() {
        try {
            ...
            echo "Ocurrió la siguiente excepción al tratar de leer los registros: " . $e->getMessage() . "\n";
        }
    }
}
?>
